...
class AppStore extends Component {
  ...
  render() {
    ...
    const searchResult = filteredApps.filter(eachItem =>
      eachItem.appName.toLowerCase().includes(inputSearch.toLowerCase()),
    )
      ...
      <div className="appStore-bg-container">
        ...
        <ul className="appSection">
          {searchResult.map(eachItem => (
            <AppItem resources={eachItem} key={eachItem.appId} />
          ))}
        </ul>
      </div>
    )
